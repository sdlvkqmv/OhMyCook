...
import { getIngredientCategory, getIngredientTranslation, INGREDIENT_CATEGORIES } from '../data/ingredients';
      ...
      <div className="flex-grow p-4 overflow-y-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {filteredIngredients.map(ing => (
                <div key={ing.name} className="bg-surface rounded-xl p-3 shadow-subtle relative">
